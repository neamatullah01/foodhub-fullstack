        ...
        <div className="bg-slate-800/50 dark:bg-slate-950/80 backdrop-blur-md border border-slate-700/50 dark:border-slate-800 rounded-3xl p-8 md:p-16 max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl">
          <div className="max-w-xl text-center md:text-left">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4 leading-tight">
              Get <span className="text-[#FFC222]">20% Off</span> Your First
              Order!
            </h2>
            <p className="text-slate-300 text-lg">
              Subscribe to our newsletter to receive exclusive discounts, new
              menu updates, and special promotions right in your inbox.
            </p>
          </div>
          ...
          <div className="w-full md:w-auto flex-1 max-w-md">
            ...
            >
              ...
              <Button
                type="submit"
                className="w-full h-14 px-8 bg-[#FFC222] hover:bg-[#e5ae1e] text-black font-bold text-lg rounded-xl transition-transform active:scale-95 shadow-lg shadow-[#FFC222]/20"
              >
                Subscribe
              </Button>
            </form>
