...
import { ArrowLeft, Loader2, ShieldCheck, Store, User, Chrome } from "lucide-react";
...
const DEMO_CREDENTIALS = [
  {
    ...
    color: "bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/40 text-blue-700 dark:text-blue-300",
  ...
  },
  {
    ...
    color: "bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-800 hover:bg-amber-100 dark:hover:bg-amber-900/40 text-amber-700 dark:text-amber-300",
  ...
  },
  {
    ...
    color: "bg-red-50 dark:bg-red-950/30 border-red-200 dark:border-red-800 hover:bg-red-100 dark:hover:bg-red-900/40 text-red-700 dark:text-red-300",
            ...
            <div className="grid grid-cols-3 gap-2">
              {DEMO_CREDENTIALS.map((cred) => (
                <button
                  ...
                  onClick={() => handleDemoLogin(cred.email, cred.password, cred.label)}
